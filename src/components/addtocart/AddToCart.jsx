            ...
            {quantity ? (
                <div className="flex justify-center gap-2 py-2">
                    <div className="fle flex-col items-center">
                        <button className=" bg-green-700 rounded-lg leading-none text-white font-bold px-2 flex items-center flex-col text-2xl h-[2rem]" onClick={() => removeFromCart(product.id)} >- </button>
                    </div>
